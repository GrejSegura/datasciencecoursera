...
This is a capstone project, a requirement to finish my Data Science Specialization course in Coursera.
The aim of this project is to create a shiny R app. Below is the project overview.
